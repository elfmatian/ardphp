CREATE TABLE IF NOT EXISTS `wp__category` (
...
CREATE TABLE IF NOT EXISTS `wp__cms` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `wp__footer` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `wp__slideshow` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
